   ...
   |cpu
      ...
      @1
         ...
         $is_i_instr = $instr[6:2] ==? 5'b0000x ||
          ...
          // New instruction type decodes
         $is_r_instr = $instr[6:2] ==? 5'b010x0 ||
                       $instr[6:2] ==? 5'b011x0;
      ...
      @2
        ...
        // Source operand values from Register File
